...
export const loader = async ({ params }) => {
  const event = await fetch(
    `https://tu-event-database-97ad64f1cb9a.herokuapp.com/events/${params.eventId}`
  );
  const categories = await fetch(
    `https://tu-event-database-97ad64f1cb9a.herokuapp.com/categories`
  );
  const users = await fetch(
    `https://tu-event-database-97ad64f1cb9a.herokuapp.com/users`
  );
  return {
